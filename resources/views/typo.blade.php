            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="nikki-image mb-30">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <img class="mb-30" src="{{('assets/frontend/img/blog-img/4.jpg')}}" alt="">
                            </div>
                            <div class="col-12 col-md-6">
                                <img class="mb-30" src="{{('assets/frontend/img/blog-img/3.jpg')}}" alt="">
                            </div>
                        </div>
                    ...
                    <div class="nikki-blockquote mb-30">
                        ...
                        <p class="mb-0">What hadn’t shown up, however, was the idea that Vietnamese cuisine can be taken seriously, with complex techniques and in a fancier setting.</p>
                    </div>
                ...
                <div class="col-12 col-sm-9 col-md-6 col-lg-4">
                    <div class="post-sidebar-area">
                        ...
                        <div class="single-widget-area mb-30">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="{{('assets/frontend/img/blog-img/lp1.jpg" a')}}lt="">
                                </div>
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="{{('assets/frontend/img/blog-img/lp2.jpg" a')}}lt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="{{('assets/frontend/img/blog-img/lp3.jpg" a')}}lt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                        ...
                        <div class="single-widget-area mb-30">
                            <!-- Adds -->
                            <a href="#"><img src="{{('assets/frontend/img/blog-img/add.png" a')}}lt=""></a>
                        </div>
