                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{('assets/frontend/img/blog-img/t1.jpg')}}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{('assets/frontend/img/blog-img/t2.jpg')}}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{('assets/frontend/img/blog-img/t3.jpg')}}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{('assets/frontend/img/blog-img/t4.jpg')}}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{('assets/frontend/img/blog-img/t5.jpg')}}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="{{('assets/frontend/img/blog-img/t6.jpg')}}" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
