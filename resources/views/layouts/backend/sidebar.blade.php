					...
					<ul class="site-logo">
						...
						<!-- START LOGO -->
							<a href="index-2.html">
								...
								<span class="brand-text"><b>Tamvan</b></span>
							</a>
						<!-- END LOGO -->
						</li>
					</ul>
					...
					<ul class="nav metismenu">
						...
						<li class="nav-dropdown active">
							...
							<ul class="collapse in nav-sub" aria-expanded="true">
								<li><a href="index-2.html"><span>Default</span></a></li>
						...
						<li class="nav-dropdown">
							<a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-article"></i><span>Managemen Blog</span></a>
